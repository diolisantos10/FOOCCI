/**
 * manual-v01-content.mjs
 *
 * Approved Manual Operacional v0.1 — seed payload.
 * Source: ChatGPT approved seed, reviewed and accepted by product owner.
 *
 * Import with:
 *   node --env-file=.env.local scripts/import-manual-v01.mjs --dry-run
 *   node --env-file=.env.local scripts/import-manual-v01.mjs --publish --source=CHATGPT
 */
