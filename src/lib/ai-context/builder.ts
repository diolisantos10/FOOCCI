...
export async function buildAIContext(
  ...
  return {
    ...
    aiConfig: {
      ...
      comboFocus:            Boolean((brandConfig.brandPersona as Record<string, unknown> | null)?.comboFocus),
      avgTicketFocus:        Boolean((brandConfig.brandPersona as Record<string, unknown> | null)?.avgTicketFocus),
      useClientName:         (brandConfig.brandPersona as Record<string, unknown> | null)?.useClientName !== false,
      canInsistAfterRefusal: (brandConfig.brandPersona as Record<string, unknown> | null)?.canInsistAfterRefusal !== false,
