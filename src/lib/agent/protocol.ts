...
const EXPERIENCE_CONSTRAINT = [
  ...
  ``,
  `PROIBIDO proativamente (sem o cliente pedir):`,
  `  ✗ Sugerir bebidas proativamente (sem o cliente perguntar)`,
  `  ✗ Sugerir sobremesas proativamente`,
  ...
  ``,
  `SE O CLIENTE PERGUNTAR SOBRE BEBIDA, SOBREMESA OU ITEM ESPECÍFICO:`,
  `  ✓ Responda IMEDIATAMENTE da categoria solicitada`,
  `  ✓ NÃO redirecione para comida primeiro`,
  `  ✓ NÃO diga "antes de falar de bebida..." ou "vamos completar o pedido primeiro"`,
  `  ✓ A intenção do cliente SEMPRE prevalece sobre o funil`,
  ``,
  ...
  ``,
  `Bebidas e sobremesas são sugeridas proativamente após o cliente finalizar. Se o cliente perguntar antes → responda IMEDIATAMENTE.`,
].join("\n");
