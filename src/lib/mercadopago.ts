 ...
 * transparente" flow. The customer never leaves Foocci: the card is tokenized in
 * the browser by the MP SDK, and only the opaque token reaches us. We POST it to
 * /v1/payments and get an immediate result.
 */
