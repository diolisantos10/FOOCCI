...
export function WhatsAppSection() {
  return (
    <section aria-labelledby="whatsapp-title" className="bg-gray-50 py-20">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
        ...
        <div className="order-2 space-y-4 lg:order-1">
          <div className="mx-auto max-w-sm overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-lg ring-1 ring-gray-900/[0.03]">
          ...
          <div className="mx-auto max-w-sm rounded-2xl border border-gray-200 bg-white p-4 shadow-sm ring-1 ring-gray-900/[0.03]">
