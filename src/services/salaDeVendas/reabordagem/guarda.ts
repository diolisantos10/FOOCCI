/**
 * A GUARDA DA CAMPANHA DE REABORDAGEM — segredo PRÓPRIO, e fechada sem ele.
 *
 * ── POR QUE MAIS UMA VARIÁVEL ───────────────────────────────────────────────
 *
 * Mesma doutrina de `raioX/guarda.ts`, e pela mesma razão: raio de alcance de
 * segredo se ESCOLHE, não se herda (ADR-003). Esta porta MANDA MENSAGEM para
 * gente de verdade — é a única deste bloco que fala com o mundo. Pendurá-la
 ...
 * no mesmo produto.
 *
 * Então: `REABORDAGEM_SECRET`, o molde da casa — hash dos dois lados,
...
export const VARIAVEL_DO_SEGREDO = "REABORDAGEM_SECRET";
export const CABECALHO_DO_SEGREDO = "x-reabordagem-secret";
...
export const MOTIVO_PORTA_DESLIGADA =
  ...
  "DISPARA MENSAGEM. Não configurada = fechada.";

export const MOTIVO_SEGREDO_ERRADO = "segredo inválido para a campanha de reabordagem";
