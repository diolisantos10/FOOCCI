      ...
      {sim && (
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs text-gray-500">
            Segurança: {sim.safety.noWhatsAppSend ? "sem envio real" : "⚠"} · {sim.safety.noRealOrder ? "sem pedido real" : "⚠"} · {sim.safety.noRealPix ? "sem Pix real" : "⚠"} · runtimeTouched={String(sim.safety.runtimeTouched)}
          </span>
        </div>
      )}
        ...
        <div className="border-t border-gray-800 px-4 py-3 text-sm">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-[11px] text-gray-500">
                Segurança: {s.safety.noWhatsAppSend ? "✓ sem envio real" : "✗ envio real"} · {s.safety.noRealOrder ? "✓ sem pedido real" : "✗ pedido real"} · {s.safety.noRealPix ? "✓ sem Pix real" : "✗ Pix real"} · runtimeTouched={String(s.safety.runtimeTouched)}
              </p>
            </div>
            <div>
