...
// O carrossel da ficha virou peça única: src/components/menu/ImageCarousel.
// Existiam duas fichas de produto neste produto e só ESTA tinha carrossel — o
// cardápio da mesa e a Loja sem IA mostravam uma foto só. Ver o cabeçalho de lá.
      ...
      <div className="relative w-full h-full flex flex-col overflow-hidden sm:max-w-md sm:h-[92vh] sm:rounded-2xl sm:shadow-2xl bg-white">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          ...
          <div className="relative w-full bg-gray-100 overflow-hidden" style={{ aspectRatio: "1 / 1", maxHeight: "50vh" }}>
            {(() => {
              // A regra de quais fotos entram (e em que ordem) mora em
              // `menuItemPhotos`. Aqui era `item.images` puro: a CAPA sumia da
              // ficha do item que a pessoa acabara de tocar.
              const imgs = menuItemPhotos(item);
              if (imgs.length === 0) {
                return (
