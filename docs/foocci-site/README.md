...
| [`creative-direction-v3-hospitalidade.md`](./creative-direction-v3-hospitalidade.md) | **Direção atual.** V3 "Hospitalidade digital inteligente": hero anfitrião, jornada, tese relacionamento→faturamento |
